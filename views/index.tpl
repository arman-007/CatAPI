...
<body>
    <div class="container col-xl-4">
        ...
        <section class="nav">
            <!-- <div class="tabs"> -->
            <button id="tab-voting" onclick="showTab('voting')" class="active"><svg
            ...
            <button id="tab-breeds" onclick="showTab('breeds')"><svg
                    ...
                    L44.769,50.425c2.145-1.606,4.051-3.513,5.657-5.656l10.402,10.402C62.391,56.732,62.391,59.266,60.828,60.828z"></path>
                        <path fill="#231F20" d="M28,4C14.745,4,4,14.745,4,28s10.745,24,24,24s24-10.745,24-24S41.255,4,28,4z M28,50
                    C15.85,50,6,40.15,6,28S15.85,6,28,6s22,9.85,22,22S40.15,50,28,50z"></path>
                        <path fill="#231F20" d="M28,11c-0.553,0-1,0.447-1,1s0.447,1,1,1c8.284,0,15,6.716,15,15c0,0.553,0.447,1,1,1s1-0.447,1-1
                    C45,18.611,37.389,11,28,11z"></path>
                    </g>
                </svg>Breeds</button>
            <button id="tab-favs" onclick="showTab('favs')"><svg class="w-6 h-6 hover:stroke-primary hover:fill-primary"
        ...
        <div id="voting" class="tab-content active">
            ...
            <div class="voting-footer flex">
                <div class="favorite padding-left">
                ...
                <div class="vote-options gap-1 padding-right">
                    ...
                    <button onclick="vote('down')"><svg class="w-6 h-6 hover:stroke-primary hover:fill-primary"
                            version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64"
                            enable-background="new 0 0 64 64" xml:space="preserve" stroke="currentColor">
                            <g>
                                <path
                                    d="M64,36c0,3.312-2.687,6-6,6H41v-0.002L40.984,42H41l2,18c0.209,2.186-1.287,4-3.498,4h-4.001
        ...
        <!-- Breeds Section -->
        <div id="breeds" class="tab-content hidden">
        ...
        <!-- Favorites Section -->
        <div id="favs" class="tab-content hidden">
            <h2>Favorites</h2>
